...
class AuthService {
  ...
  // Note: La gestion des favoris a été déplacée vers FirestoreService (Subcollection)
  // et l'objectif mensuel vers LocalStorageService (Local) conformément aux consignes.
